...
const CertificateItem = ({img, dsc}) => {
  return (
    <div className='relative flex items-center h-[300px] w-[400px] overflow-hidden justify-center shadow-xl shadow-grey-400 rounded-lg group hover:bg-gradient-to-r from-gray-200 to-[#001b5e]'>
