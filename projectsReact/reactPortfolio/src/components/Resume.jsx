  ...
  return (
    <div id="resume" className="max-w-[1280px] m-auto md:pl-20 p-4 py-16">
      ...
      <span className=" text-justify " >
        ...
        and the monthly elimination at 42 Warsaw and become a student of an IT
        Solutions Designer and Developer. While studying and working on my
        portfolio, I actively use the Version Control System - GIT and work on
