...
const Main = () => {
  return (
    <div id="main" className="h-4/5 overflow-hidden relative">
      <div className="top-0 left-0 z-50 fixed md:fixed h-12 w-12 m-2 flex items-center justify-center">
        <a href="#main"><img className="filter invert"
